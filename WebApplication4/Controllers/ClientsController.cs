...
namespace WebApplication4.Controllers
{
    ...
    public class ClientsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nom,Prenom,Age,Email,Adresse,Tel")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nom,Prenom,Age,Email,Adresse,Tel")] Client client)
        {
            if (ModelState.IsValid)
            {
